...
activities = {
    ...
    "Drama Club": {
        "description": "Perform scenes, improve acting skills, and prepare productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["elena@mergington.edu", "noah@mergington.edu"]
    },
    "Science Olympiad": {
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPExecution(status_code=400, detail="Student already signed up")
